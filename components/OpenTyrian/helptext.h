...
EXT_RAM_ATTR extern char pName[21][16];
EXT_RAM_ATTR extern char miscText[HELPTEXT_MISCTEXT_COUNT][42];
EXT_RAM_ATTR extern char miscTextB[HELPTEXT_MISCTEXTB_COUNT][HELPTEXT_MISCTEXTB_SIZE];
EXT_RAM_ATTR extern char keyName[8][18];
EXT_RAM_ATTR extern char menuText[7][HELPTEXT_MENUTEXT_SIZE];
EXT_RAM_ATTR extern char outputs[9][31];
EXT_RAM_ATTR extern char topicName[6][21];
EXT_RAM_ATTR extern char mainMenuHelp[HELPTEXT_MAINMENUHELP_COUNT][66];
EXT_RAM_ATTR extern char inGameText[6][21];
EXT_RAM_ATTR extern char detailLevel[6][13];
EXT_RAM_ATTR extern char gameSpeedText[5][13];
EXT_RAM_ATTR extern char inputDevices[3][13];
EXT_RAM_ATTR extern char networkText[HELPTEXT_NETWORKTEXT_COUNT][HELPTEXT_NETWORKTEXT_SIZE];
EXT_RAM_ATTR extern char difficultyNameB[11][21];
EXT_RAM_ATTR extern char joyButtonNames[5][21];
EXT_RAM_ATTR extern char superShips[HELPTEXT_SUPERSHIPS_COUNT][26];
EXT_RAM_ATTR extern char specialName[HELPTEXT_SPECIALNAME_COUNT][10];
EXT_RAM_ATTR extern char destructHelp[25][22];
EXT_RAM_ATTR extern char weaponNames[17][17];
EXT_RAM_ATTR extern char destructModeName[DESTRUCT_MODES][13];
EXT_RAM_ATTR extern char shipInfo[HELPTEXT_SHIPINFO_COUNT][2][256];
EXT_RAM_ATTR extern char menuInt[MENU_MAX+1][11][18];
