...
EXT_RAM_ATTR extern JE_MultiEnemyType enemy;
...
EXT_RAM_ATTR extern explosion_type explosions[MAX_EXPLOSIONS];
...
EXT_RAM_ATTR extern EnemyShotType enemyShot[ENEMY_SHOT_MAX];
