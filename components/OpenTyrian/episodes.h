...
EXT_RAM_ATTR extern JE_WeaponPortType weaponPort;
EXT_RAM_ATTR extern JE_WeaponType weapons[WEAP_NUM + 1];
extern JE_PowerType powerSys;
extern JE_ShipType ships;
EXT_RAM_ATTR extern JE_OptionType options[OPTION_NUM + 1];
extern JE_ShieldType shields;
extern JE_SpecialType special;
EXT_RAM_ATTR extern JE_EnemyDatType enemyDat;
